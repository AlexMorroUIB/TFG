(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    /* global AFRAME */if("undefined"==typeof AFRAME)throw new Error("Component attempted to register before AFRAME was available.");/**
...
// for order-sorted hoverEls (grabbing; no-op for distance-sorted (pointing)
    ...
    /* global AFRAME, THREE */const inherit=AFRAME.utils.extendDeep,physicsCore=require("./prototypes/physics-grab-proto.js"),buttonsCore=require("./prototypes/buttons-proto.js"),base=inherit({},physicsCore,buttonsCore);// new object with all core modules
...
// base code used by grabbable for physics interactions
    ...
    /* global AFRAME, THREE */const inherit=AFRAME.utils.extendDeep,buttonsCore=require("./prototypes/buttons-proto.js"),base=inherit({},buttonsCore);// new object with all core modules
